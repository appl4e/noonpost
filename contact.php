    ...
    <div class="row mb-20">
      <div class="col-lg-8 mt-30">
        <div class="contact">
          ...
          <form action="https://noonpost.netlify.app/html/template/assets/php/mail.php" class="widget-form contact_form " id="main_contact_form">
            ...
            <div class="form-group">
              <textarea name="message" id="message" cols="30" rows="5" class="form-control" placeholder="Your Message*"
